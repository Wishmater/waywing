...
class OrgKdeStatusNotifierWatcherStatusNotifierItemRegistered extends DBusSignal {
  ...
  OrgKdeStatusNotifierWatcherStatusNotifierItemRegistered(DBusSignal signal)
    : super(
...
class OrgKdeStatusNotifierWatcherStatusNotifierItemUnregistered extends DBusSignal {
  ...
  OrgKdeStatusNotifierWatcherStatusNotifierItemUnregistered(DBusSignal signal)
    : super(
        sender: signal.sender,
        path: signal.path,
        interface: signal.interface,
...
class OrgKdeStatusNotifierWatcherStatusNotifierHostRegistered extends DBusSignal {
  OrgKdeStatusNotifierWatcherStatusNotifierHostRegistered(DBusSignal signal)
    : super(
        sender: signal.sender,
        path: signal.path,
        interface: signal.interface,
...
class OrgKdeStatusNotifierWatcherStatusNotifierHostUnregistered extends DBusSignal {
  OrgKdeStatusNotifierWatcherStatusNotifierHostUnregistered(DBusSignal signal)
    : super(
        sender: signal.sender,
        path: signal.path,
        interface: signal.interface,
...
class OrgKdeStatusNotifierWatcher extends DBusRemoteObject {
  ...
  OrgKdeStatusNotifierWatcher(DBusClient client, String destination, DBusObjectPath path)
    ...
    ).asBroadcastStream().map((signal) => OrgKdeStatusNotifierWatcherStatusNotifierItemRegistered(signal));
    ...
    statusNotifierItemUnregistered = DBusRemoteObjectSignalStream(
      ...
      signature: DBusSignature("s"),
    ).asBroadcastStream().map((signal) => OrgKdeStatusNotifierWatcherStatusNotifierItemUnregistered(signal));
    ...
    ).asBroadcastStream().map((signal) => OrgKdeStatusNotifierWatcherStatusNotifierHostRegistered(signal));

    statusNotifierHostUnregistered = DBusRemoteObjectSignalStream(
      object: this,
      interface: "org.kde.StatusNotifierWatcher",
      name: "StatusNotifierHostUnregistered",
      signature: DBusSignature(""),
    ).asBroadcastStream().map((signal) => OrgKdeStatusNotifierWatcherStatusNotifierHostUnregistered(signal));
  }
  ...
  Future<void> callRegisterStatusNotifierItem(
    String service, {
  ...
  Future<void> callRegisterStatusNotifierHost(
    String service, {
    bool noAutoStart = false,
    bool allowInteractiveAuthorization = false,
  }) async {
