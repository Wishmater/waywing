...
/// ## Design discussion
///
/// ### Why use a [BetterPadding] widget rather than a [Container] with a [Container.padding] property?
///
/// There isn't really any difference between the two. If you supply a
/// [Container.padding] argument, [Container] builds a [BetterPadding] widget
/// for you.
///
...
/// [BetterPadding] widget and the [Container.decoration] property causes the
...
class BetterPadding extends SingleChildRenderObjectWidget {
  /// Creates a widget that insets its child.
  const BetterPadding({super.key, required this.padding, super.child});
  ...
  @override
  void updateRenderObject(BuildContext context, RenderBetterPadding renderObject) {
    renderObject
      ..padding = padding
...
/// size. Padding then sizes itself to its child's size, inflated by the
/// padding, effectively creating empty space around the child.
class RenderBetterPadding extends RenderShiftedBox {
